 ...
 * shields.io and are best-effort (wickra-pico is not published yet, so they
...
const PROFILE = 'https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-pico'

// Source of truth for the footer badge row. Mirrors the wickra-pico README.
const badges = [
  { alt: 'CI', slug: 'ci', src: `${PROFILE}/ci.svg`, href: 'https://github.com/wickra-lib/wickra-pico/actions/workflows/ci.yml' },
  { alt: 'CodeQL', slug: 'codeql', src: `${PROFILE}/codeql.svg`, href: 'https://github.com/wickra-lib/wickra-pico/actions/workflows/codeql.yml' },
  { alt: 'codecov', slug: 'codecov', src: `${PROFILE}/codecov.svg`, href: 'https://codecov.io/gh/wickra-lib/wickra-pico' },
  { alt: 'GitHub release', slug: 'release', src: 'https://img.shields.io/github/v/release/wickra-lib/wickra-pico?logo=github&color=green', href: 'https://github.com/wickra-lib/wickra-pico/releases/latest' },
  { alt: 'License: MIT OR Apache-2.0', slug: 'license', src: `${PROFILE}/license.svg`, href: 'https://github.com/wickra-lib/wickra-pico#license' },
  { alt: 'OpenSSF Scorecard', slug: 'scorecard', src: `${PROFILE}/scorecard.svg`, href: 'https://scorecard.dev/viewer/?uri=github.com/wickra-lib/wickra-pico' },
  { alt: 'OpenSSF Best Practices', slug: 'best-practices', src: `${PROFILE}/best-practices.svg`, href: 'https://www.bestpractices.dev/' },
  { alt: 'Build provenance', slug: 'provenance', src: `${PROFILE}/provenance.svg`, href: 'https://github.com/wickra-lib/wickra-pico/attestations' },
  { alt: 'Verified across 10 languages', slug: 'verified', src: `${PROFILE}/verified.svg`, href: 'https://github.com/wickra-lib/wickra-pico/tree/main/golden' },
]
...
for (const b of badges) {
  try {
    if (b.slug === 'release') {
      const v = (await ghJson('repos/wickra-lib/wickra-pico/releases/latest')).tag_name
      b.src = `https://img.shields.io/badge/release-${escBadge(v)}-green?logo=github`
    } else if (b.slug === 'go') {
      const v = (await ghJson('repos/wickra-lib/wickra-pico-go/tags'))[0]?.name
